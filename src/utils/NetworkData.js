...
export default function NetworkData (data) {
  const nodes = [
    ...
    { id: 'Daylight', label: 'Daylight', x: -310, y: -180, group: 'Lighting' },
    { id: 'Dawn', label: 'Dawn', x: -240, y: -210, group: 'Lighting' },
    { id: 'Darkness', label: 'Darkness', x: -170, y: -240, group: 'Lighting' },
    { id: 'Dusk', label: 'Dusk', x: -100, y: -270, group: 'Lighting' },
